      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 animate-fade-in">
        <div className="max-w-md text-center space-y-4">
          ...
          <p className="text-gray-600">
            No details available for {decodedCourseName}
          </p>
          <Link
            to="/"
      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <header className="mb-12">
          <div className="space-y-4">
            ...
            <h2 className="text-xl text-gray-600 font-medium">{course.subtitle}</h2>
          </div>
        </header>
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h4 className="text-xl font-semibold text-gray-800">{module.title}</h4>
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="mt-3 font-medium text-gray-800">{testimonial.student}</p>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg sticky top-8">
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  {course.discount && (
                    <p className="mt-1 text-sm text-green-600">{course.discount}</p>
                  )}
                </div>
